...
CREATE TABLE fs_balance_sheet_item (
    ...
    gaap_type           TEXT NOT NULL,   -- 'ASBE'（企业会计准则）, 'ASSE'（小企业会计准则）, 未来可扩展
...
CREATE TABLE fs_balance_sheet_item_dict (
    ...
    gaap_type       TEXT NOT NULL,        -- 'ASBE' 或 'ASSE'
...
('ASBE', 'CONTRACT_ASSETS', '合同资产', 8, 'ASSET', 80, 0),
('ASBE', 'OTHER_RECEIVABLES', '其他应收款', 9, 'ASSET', 90, 0),
('ASBE', 'INVENTORY', '存货', 10, 'ASSET', 100, 0),
('ASBE', 'CONTRACT_ASSETS', '合同资产', 11, 'ASSET', 110, 0),   -- 注意第10栏合同资产，但之前已有合同资产？根据表格是第10栏，但第8栏也是合同资产？需核对原表：第8栏是其他应收款？原表第8是其他应收款，第9是存货，第10是合同资产。我们按原表顺序。此处修正。
-- 实际上原表顺序：
...
('ASBE', 'OTHER_EQUITY_INSTRUMENTS', '其他权益工具投资', 19, 'ASSET', 190, 0),
...
('ASBE', 'PREFERRED_STOCK', '其中：优先股', 51, 'LIABILITY', 510, 0),   -- 注意51行是优先股（列在应付债券下）
('ASBE', 'PERPETUAL_BONDS', '永续债', 52, 'LIABILITY', 520, 0),
('ASBE', 'LEASE_LIABILITIES', '租赁负债', 53, 'LIABILITY', 530, 0),
('ASBE', 'LONG_TERM_PAYABLES', '长期应付款', 54, 'LIABILITY', 540, 0),
('ASBE', 'PROVISIONS', '预计负债', 55, 'LIABILITY', 550, 0),
('ASBE', 'DEFERRED_INCOME', '递延收益', 56, 'LIABILITY', 560, 0),
('ASBE', 'DEFERRED_TAX_LIABILITIES', '递延所得税负债', 57, 'LIABILITY', 570, 0),
('ASBE', 'OTHER_NON_CURRENT_LIABILITIES', '其他非流动负债', 58, 'LIABILITY', 580, 0),
('ASBE', 'NON_CURRENT_LIABILITIES', '非流动负债合计', 59, 'LIABILITY', 590, 1),

-- 负债合计
('ASBE', 'LIABILITIES', '负债合计', 60, 'LIABILITY', 600, 1),

-- 所有者权益
('ASBE', 'SHARE_CAPITAL', '实收资本（或股本）', 61, 'EQUITY', 610, 0),
('ASBE', 'OTHER_EQUITY_INSTRUMENTS', '其他权益工具', 62, 'EQUITY', 620, 0),
('ASBE', 'PREFERRED_STOCK', '其中：优先股', 63, 'EQUITY', 630, 0),
('ASBE', 'PERPETUAL_BONDS', '永续债', 64, 'EQUITY', 640, 0),
('ASBE', 'CAPITAL_RESERVE', '资本公积', 65, 'EQUITY', 650, 0),
('ASBE', 'TREASURY_STOCK', '减:库存股', 66, 'EQUITY', 660, 0),
('ASBE', 'OTHER_COMPREHENSIVE_INCOME', '其他综合收益', 67, 'EQUITY', 670, 0),
('ASBE', 'SPECIAL_RESERVE', '专项储备', 68, 'EQUITY', 680, 0),
('ASBE', 'SURPLUS_RESERVE', '盈余公积', 69, 'EQUITY', 690, 0),
('ASBE', 'RETAINED_EARNINGS', '未分配利润', 70, 'EQUITY', 700, 0),
('ASBE', 'EQUITY', '所有者权益（或股东权益）合计', 71, 'EQUITY', 710, 1),

-- 负债和所有者权益总计
('ASBE', 'LIABILITIES_AND_EQUITY', '负债和所有者权益（或股东权益）总计', 72, 'LIABILITY_EQUITY', 720, 1);
```
...
('ASSE', 'RAW_MATERIALS', '其中：原材料', 10, 'ASSET', 100, 0),   -- 存货明细
...
('ASSE', 'EQUITY', '所有者权益（或股东权益）合计', 52, 'EQUITY', 520, 1),

-- 负债和所有者权益总计
('ASSE', 'LIABILITIES_AND_EQUITY', '负债和所有者权益（或股东权益）总计', 53, 'LIABILITY_EQUITY', 530, 1);
```
...
('货币资金', 'cash_end', 'ASBE', 2),
('货币资金期初', 'cash_begin', 'ASBE', 2),
('货币资金期末', 'cash_end', 'ASBE', 2),
('现金', 'cash_end', 'ASBE', 1),
('第1行', 'cash_end', 'ASBE', 3),
('1行', 'cash_end', 'ASBE', 3);
...
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('应收账款', 'accounts_receivable_end', 'ASBE', 2),
('应收账款期初', 'accounts_receivable_begin', 'ASBE', 2),
('应收', 'accounts_receivable_end', 'ASBE', 1),
('第5行', 'accounts_receivable_end', 'ASBE', 3),
('5行', 'accounts_receivable_end', 'ASBE', 3);

-- 存货 (INVENTORY)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('存货', 'inventory_end', 'ASBE', 2),
('存货期初', 'inventory_begin', 'ASBE', 2),
('库存', 'inventory_end', 'ASBE', 1),
('第9行', 'inventory_end', 'ASBE', 3),
('9行', 'inventory_end', 'ASBE', 3);

-- 固定资产 (FIXED_ASSETS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('固定资产', 'fixed_assets_end', 'ASBE', 2),
('固定资产原值', 'fixed_assets_end', 'ASBE', 1),
('第22行', 'fixed_assets_end', 'ASBE', 3),
('22行', 'fixed_assets_end', 'ASBE', 3);

-- 短期借款 (SHORT_TERM_LOANS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('短期借款', 'short_term_loans_end', 'ASBE', 2),
('短借', 'short_term_loans_end', 'ASBE', 1),
('第35行', 'short_term_loans_end', 'ASBE', 3),
('35行', 'short_term_loans_end', 'ASBE', 3);

-- 应付账款 (ACCOUNTS_PAYABLE)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('应付账款', 'accounts_payable_end', 'ASBE', 2),
('应付', 'accounts_payable_end', 'ASBE', 1),
('第39行', 'accounts_payable_end', 'ASBE', 3),
('39行', 'accounts_payable_end', 'ASBE', 3);

-- 实收资本 (SHARE_CAPITAL)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('实收资本', 'share_capital_end', 'ASBE', 2),
('股本', 'share_capital_end', 'ASBE', 1),
('第61行', 'share_capital_end', 'ASBE', 3),
('61行', 'share_capital_end', 'ASBE', 3);

-- 未分配利润 (RETAINED_EARNINGS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('未分配利润', 'retained_earnings_end', 'ASBE', 2),
('未分配', 'retained_earnings_end', 'ASBE', 1),
('第70行', 'retained_earnings_end', 'ASBE', 3),
('70行', 'retained_earnings_end', 'ASBE', 3);

-- 资产总计 (ASSETS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('资产总计', 'assets_end', 'ASBE', 2),
('总资产', 'assets_end', 'ASBE', 1),
('资产合计', 'assets_end', 'ASBE', 1),
('第34行', 'assets_end', 'ASBE', 3),
('34行', 'assets_end', 'ASBE', 3);

-- 负债和所有者权益总计 (LIABILITIES_AND_EQUITY)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('负债和所有者权益总计', 'liabilities_and_equity_end', 'ASBE', 2),
('负债及权益总计', 'liabilities_and_equity_end', 'ASBE', 1),
('权益总计', 'liabilities_and_equity_end', 'ASBE', 1),
('第72行', 'liabilities_and_equity_end', 'ASBE', 3),
('72行', 'liabilities_and_equity_end', 'ASBE', 3);
```
...
-- 货币资金 (CASH)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('货币资金', 'cash_end', 'ASSE', 2),
('货币资金期初', 'cash_begin', 'ASSE', 2),
('现金', 'cash_end', 'ASSE', 1),
('第1行', 'cash_end', 'ASSE', 3),
('1行', 'cash_end', 'ASSE', 3);
...
('短投', 'short_term_investments_end', 'ASSE', 1),
('第2行', 'short_term_investments_end', 'ASSE', 3),
('2行', 'short_term_investments_end', 'ASSE', 3);

-- 存货 (INVENTORY)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('存货', 'inventory_end', 'ASSE', 2),
('存货期初', 'inventory_begin', 'ASSE', 2),
('第9行', 'inventory_end', 'ASSE', 3),
('9行', 'inventory_end', 'ASSE', 3);

-- 原材料 (RAW_MATERIALS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('原材料', 'raw_materials_end', 'ASSE', 2),
('原料', 'raw_materials_end', 'ASSE', 1),
('第10行', 'raw_materials_end', 'ASSE', 3),
('10行', 'raw_materials_end', 'ASSE', 3);

-- 固定资产原价 (FIXED_ASSETS_ORIGINAL)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('固定资产原价', 'fixed_assets_original_end', 'ASSE', 2),
('固定资产原值', 'fixed_assets_original_end', 'ASSE', 1),
('第18行', 'fixed_assets_original_end', 'ASSE', 3),
('18行', 'fixed_assets_original_end', 'ASSE', 3);

-- 累计折旧 (ACCUMULATED_DEPRECIATION)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('累计折旧', 'accumulated_depreciation_end', 'ASSE', 2),
('折旧', 'accumulated_depreciation_end', 'ASSE', 1),
('第19行', 'accumulated_depreciation_end', 'ASSE', 3),
('19行', 'accumulated_depreciation_end', 'ASSE', 3);

-- 固定资产账面价值 (FIXED_ASSETS_NET)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('固定资产账面价值', 'fixed_assets_net_end', 'ASSE', 2),
('固定资产净值', 'fixed_assets_net_end', 'ASSE', 1),
('第20行', 'fixed_assets_net_end', 'ASSE', 3),
('20行', 'fixed_assets_net_end', 'ASSE', 3);

-- 短期借款 (SHORT_TERM_LOANS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('短期借款', 'short_term_loans_end', 'ASSE', 2),
('短借', 'short_term_loans_end', 'ASSE', 1),
('第31行', 'short_term_loans_end', 'ASSE', 3),
('31行', 'short_term_loans_end', 'ASSE', 3);

-- 应付职工薪酬 (EMPLOYEE_BENEFITS_PAYABLE)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('应付职工薪酬', 'employee_benefits_payable_end', 'ASSE', 2),
('应付工资', 'employee_benefits_payable_end', 'ASSE', 1),
('第35行', 'employee_benefits_payable_end', 'ASSE', 3),
('35行', 'employee_benefits_payable_end', 'ASSE', 3);

-- 实收资本 (SHARE_CAPITAL)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('实收资本', 'share_capital_end', 'ASSE', 2),
('股本', 'share_capital_end', 'ASSE', 1),
('第48行', 'share_capital_end', 'ASSE', 3),
('48行', 'share_capital_end', 'ASSE', 3);

-- 未分配利润 (RETAINED_EARNINGS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('未分配利润', 'retained_earnings_end', 'ASSE', 2),
('未分配', 'retained_earnings_end', 'ASSE', 1),
('第51行', 'retained_earnings_end', 'ASSE', 3),
('51行', 'retained_earnings_end', 'ASSE', 3);

-- 资产合计 (ASSETS)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('资产合计', 'assets_end', 'ASSE', 2),
('总资产', 'assets_end', 'ASSE', 1),
('第30行', 'assets_end', 'ASSE', 3),
('30行', 'assets_end', 'ASSE', 3);

-- 负债合计 (LIABILITIES)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('负债合计', 'liabilities_end', 'ASSE', 2),
('总负债', 'liabilities_end', 'ASSE', 1),
('第47行', 'liabilities_end', 'ASSE', 3),
('47行', 'liabilities_end', 'ASSE', 3);

-- 所有者权益合计 (EQUITY)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('所有者权益合计', 'equity_end', 'ASSE', 2),
('股东权益合计', 'equity_end', 'ASSE', 1),
('第52行', 'equity_end', 'ASSE', 3),
('52行', 'equity_end', 'ASSE', 3);

-- 负债和所有者权益总计 (LIABILITIES_AND_EQUITY)
INSERT INTO fs_balance_sheet_synonyms (phrase, column_name, gaap_type, priority) VALUES
('负债和所有者权益总计', 'liabilities_and_equity_end', 'ASSE', 2),
('负债及权益总计', 'liabilities_and_equity_end', 'ASSE', 1),
('第53行', 'liabilities_and_equity_end', 'ASSE', 3),
('53行', 'liabilities_and_equity_end', 'ASSE', 3);
```
