    ...
    <div className={s.reportPage}>
      ...
      <div className={s.scrollWrap}>
        <div className={s.disclaimer}>
          ...
          本报告由人工智能大语言模型基于企业画像数据自动生成，仅供内部参考与辅助决策使用，不构成正式审计意见、税务鉴证结论或法律建议。报告中的分析、判断及建议均基于所提供数据的完整性与准确性，可能存在因数据缺失、口径差异或模型局限导致的偏差。涉及税收优惠适用、税务筹划方案及合规风险评估等内容，应以主管税务机关的最终认定为准，建议结合注册会计师、注册税务师等专业人士意见审慎决策。使用本报告所产生的任何后果，由使用方自行承担。
        </div>
